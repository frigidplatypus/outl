...
class OutlBeta < Formula
  ...
  bottle do
    root_url "https://github.com/outlmd/outl/releases/download/v0.12.0-beta.200" # anchor: bottle-root-url
    sha256 cellar: :any_skip_relocation, arm64_ventura: "f33ad9bd9d4bdba495c115cf3ad96382320658c0cd004ded64a0fb90ff7a1481" # anchor: bottle-macos-arm64
    sha256 cellar: :any_skip_relocation, ventura:       "f60966ecae6b5cb50f4bd2ffe7dedd9d972d742ffa3c036564b19e1c971c13f3" # anchor: bottle-macos-x64
    sha256 cellar: :any_skip_relocation, x86_64_linux:  "42a142c844394db72796e48c0917823a382881e55284a4e240557cc42070f705" # anchor: bottle-linux-x64
  end

  on_macos do
    on_arm do
      url "https://github.com/outlmd/outl/releases/download/v#{version}/outl-macos-arm64.tar.gz"
      sha256 "894d621c20a58436b9b1ac4aa0f3c7f5ca8ff5eab5bfda63363af285d4872c04" # anchor: macos-arm64
    end
    on_intel do
      url "https://github.com/outlmd/outl/releases/download/v#{version}/outl-macos-x64.tar.gz"
      sha256 "fc81f6c61cef7ba813a5333da74f8ee86bf1ed7c0a2512b54c3d4cf7c7225b69" # anchor: macos-x64
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "bdbcf22cba1e3781d7cce4fc91839ec646ed0c35ebf92a3c1c42ece3fcfe4e2e" # anchor: linux-x64
    end
  end
