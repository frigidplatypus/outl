...
pub fn outl() -> Palette {
    ...
    Palette {
        ...
        header_fg_1: accent.into(),
        header_fg_2: blue.into(),
        header_fg_3: magenta.into(),
        header_fg_4: accent_alt.into(),
        header_fg_5: warn.into(),
        header_fg_6: accent_soft.into(),
...
pub fn default_dark() -> Palette {
    ...
    Palette {
        ...
        header_fg_1: cyan.into(),
        header_fg_2: blue.into(),
        header_fg_3: magenta.into(),
        header_fg_4: green.into(),
        header_fg_5: yellow.into(),
        header_fg_6: gray.into(),
...
pub fn light() -> Palette {
    ...
    Palette {
        ...
        heading_fg: fg.into(),
        dim_fg: gray.into(),
        header_fg_1: blue.into(),
        header_fg_2: green.into(),
        header_fg_3: magenta.into(),
        header_fg_4: red.into(),
        header_fg_5: yellow.into(),
        header_fg_6: dark_gray.into(),
...
pub fn logseq_light() -> Palette {
    ...
    Palette {
        ...
        dim_fg: fg_dim.into(),
        header_fg_1: title.into(),
        header_fg_2: blue.into(),
        header_fg_3: blue_deep.into(),
        header_fg_4: green.into(),
        header_fg_5: orange.into(),
        header_fg_6: violet.into(),
        selected_bullet_bg: blue.into(),
        selected_bullet_fg: bg.into(),
        cursor_block_bg: fg.into(),
        cursor_block_fg: bg.into(),
...
pub fn dracula() -> Palette {
    ...
    Palette {
        ...
        dim_fg: comment.into(),
        header_fg_1: pink.into(),
        header_fg_2: purple.into(),
        header_fg_3: cyan.into(),
        header_fg_4: green.into(),
        header_fg_5: orange.into(),
        header_fg_6: yellow.into(),
        selected_bullet_bg: cyan.into(),
        selected_bullet_fg: bg.into(),
        cursor_block_bg: fg.into(),
        cursor_block_fg: bg.into(),
...
pub fn solarized_dark() -> Palette {
    ...
    Palette {
        ...
        header_fg_1: cyan.into(),
        header_fg_2: blue.into(),
        header_fg_3: violet.into(),
        header_fg_4: green.into(),
        header_fg_5: yellow.into(),
        header_fg_6: magenta.into(),
        selected_bullet_bg: cyan.into(),
...
pub fn nord() -> Palette {
    ...
    Palette {
        ...
        dim_fg: "#4c566a".into(),
        header_fg_1: frost1.into(),
        header_fg_2: frost2.into(),
        header_fg_3: frost3.into(),
        header_fg_4: aurora_green.into(),
        header_fg_5: aurora_yellow.into(),
        header_fg_6: aurora_purple.into(),
...
pub fn gruvbox() -> Palette {
    ...
    Palette {
        ...
        heading_fg: fg.into(),
        dim_fg: fg_dimmer.into(),
        header_fg_1: yellow.into(),
        header_fg_2: aqua.into(),
        header_fg_3: green.into(),
        header_fg_4: orange.into(),
        header_fg_5: purple.into(),
        header_fg_6: blue.into(),
